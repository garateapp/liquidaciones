     ...
     <!-- Start Open Menu -->
      <aside class="animate__animated animate__fadeInLeft w-52 relative z-0 flex-shrink-0 hidden px-4 overflow-y-auto bg-gray-100 sm:block " 
        ...
        <div class="mb-6">
          ...
          <h1 class="mt-4">Bases de datos</h1>
          ...
          <div class="grid grid-cols-1 gap-4 grid-cols-2 mt-2">
              ...
              <a href="{{route('temporada.recepcion',$temporada)}}"
                ...
                wire:navigate class="col-span-2">
                  <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                    ...
                    <p class="text-xs mt-1 text-center font-semibold">Procesos</p>
                  </div>
                </a>
                <a href="{{route('temporada.despachos',$temporada)}}"
                wire:navigate class="col-span-2">
                  <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                    <div class="rounded-full p-2 @if($masascount->count()>0)bg-green-200 @else bg-indigo-200 @endif flex flex-col items-center">
                      <i class="fas fa-shopping-basket fa-sm @if($masascount->count()>0)text-green-600 @else text-indigo-600 @endif"></i>
                    </div>
                    <p class="text-xs mt-1 text-center font-semibold">Despachos</p>
                  </div>
                </a>
              
                <a href="{{route('temporada.embarques',$temporada)}}"
                wire:navigate class="col-span-2">
                  <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                    <div class="rounded-full p-2 @if($masascount->count()>0)bg-green-200 @else bg-indigo-200 @endif flex flex-col items-center">
                      <i class="fas fa-shopping-basket fa-sm @if($masascount->count()>0)text-green-600 @else text-indigo-600 @endif"></i>
                    </div>
                    <p class="text-xs mt-1 text-center font-semibold">Embarques</p>
                  </div>
                </a>
            ...
            wire:navigate>
              ...
              wire:navigate>
               ...
               <!-- Start Navitem -->
               <a href="{{route('temporada.fobtree',$temporada)}}"
               wire:navigate>
                 <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                   <div class="rounded-full p-2 @if($temporada->fobs->count()>0)bg-green-200 @else bg-indigo-200 @endif flex flex-col items-center">
                     <i class="fas fa-shopping-basket fa-sm @if($temporada->fobs->count()>0)text-green-600 @else text-indigo-600 @endif"></i>
                   </div>
                   <p class="text-xs mt-1 text-center font-semibold">Fob tree</p>
                 </div>
               </a>
          ...
          <div class="grid grid-cols-1 gap-4 grid-cols-2 mt-2">
            ...
            wire:navigate>
              <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                ...
                <p class="text-xs mt-1 text-center font-semibold">Listado de Productores</p>
              </div>
            </a>
            <!-- Start Navitem -->
              ...
              @foreach ($costomenus as $costomenu)
                @if ($item)
                    ...
                    <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                      ...
                      <p class="text-xs mt-1 text-center font-semibold">{{$costomenu->name}}</p>
                    </div>
                    </a>
                @endif
              @endforeach
          ...
          <div class="grid grid-cols-1 gap-4 grid-cols-2 mt-2">
            ...
            wire:navigate>
              <div class="p-2 flex flex-col items-center bg-white rounded-md justify-center shadow-xl cursor-pointer">
                <div class="rounded-full p-2 @if($temporada->packings->count()>0 || $temporada->packingcodes->count()>0)bg-green-200 @else bg-indigo-200 @endif flex flex-col items-center">
                  <i class="fas fa-chart-pie fa-sm @if($temporada->packings->count()>0 || $temporada->packingcodes->count()>0)text-green-600 @else text-indigo-600 @endif"></i>
                </div>
