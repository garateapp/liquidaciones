...
{{-- Raíz del componente: 2 columnas con gap y SIN overflow oculto --}}
<div x-data="{ open: @entangle('detalleOpen') }" class="grid grid-cols-12 gap-4 overflow-visible px-2 md:px-4">

  {{-- IZQUIERDA: LISTADO (h del viewport + scroll) --}}
  ...
  <div class="col-span-5 xl:col-span-4">
    ...
    >
      {{-- Contenedor alto viewport, con scroll interno y contenido centrado --}}
      <div class="h-[calc(100vh-32px)] overflow-y-auto flex justify-center">
        {{-- Card centrada --}}
        <div
          class="w-full max-w-[560px] bg-white border rounded-xl shadow p-4 space-y-3"
