<div class="bg-white p-8 rounded-md w-full" x-data="{alert:true}">
    ...
    <div class=" flex items-center justify-between pb-6">
      ...
      <div>
                    ...
                    <a href="{{route('temporadas.show',$temporada)}}">
                        ...
                        <div>
                            ...
                            <div class="flex w-0 flex-1">
                                <a href="{{route('temporadas.show',$temporada)}}" class="relative -mr-px inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
                            ...
                            <div class="-ml-px flex w-0 flex-1">
                                <a href="{{route('temporadas.show',$temporada)}}" class="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border border-transparent py-4 text-sm font-semibold text-gray-900">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
        ...
        <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto hidden">
