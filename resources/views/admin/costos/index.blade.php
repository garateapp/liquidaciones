<x-app-layout>
    ...
    <div class="flex justify-center">
      ...
      <span class="text-gray-600 text-lg font-semibold">Asignación por especie</span>
      <x-table-responsive>   
      ...
      <span class="text-gray-600 text-lg font-semibold">Asignación por categoria</span>
      <x-table-responsive>   
         <table class="min-w-full divide-y divide-gray-200 mb-20 pb-20">
      ...
      <span class="text-gray-600 text-lg font-semibold">Menu - Costos</span>
      <div class="flex justify-end mb-6 -mt-4">
         <a href="{{route('costomenus.create')}}">
            <button  class="ml-auto items-center focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 sm:mt-0 px-6 py-3 bg-gray-500 hover:bg-gray-500 focus:outline-none rounded">
               <p class="text-sm font-medium leading-none text-white">Crear Nuevo Menu</p>
            </button>
         </a>
      </div>
      <x-table-responsive>   
