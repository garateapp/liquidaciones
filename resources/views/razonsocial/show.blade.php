<x-app-layout>
    ...
    <div class="pb-8 pt-2">
      ...
      <div class="">
        <div class="px-2 md:px-2 py-4 w-full">
          ...
          <div class="flex flex-col items-center justify-center min-h-screen bg-gray-100 w-full">
            ...
            <div class="w-full m-4">
              <div class="max-w-7xl w-full mx-auto grid gap-4 grid-cols-1">
                ...
                <!-- profile card -->
                <div class="flex flex-col sticky top-0 z-10 w-full">
                ...
                <h1 class="text-xl">Liquidaciones</h1>

                  <!---stats-->
                
                  <div class="flex flex-col w-full">
                    <div class="lg:w-3/6 p-4 bg-gray-800 border-gray-800 shadow-md hover:shodow-lg rounded-2xl">
                      <div class="flex-none lg:flex">
                        <div class=" h-full w-full lg:h-24 lg:w-24   lg:mb-0 mb-3">
