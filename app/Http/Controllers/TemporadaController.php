...
class TemporadaController extends Controller
{
    ...
    {   $masascat1=Balancemasa::where('temporada_id',$temporada->id)->where('n_categoria','Cat 1')->where('n_etiqueta','!=','Alsu')->whereNull('precio_fob')->paginate(5000);
        ...
        foreach($masascat1 as $masa){
                if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='4J' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='4JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='4JDD'){
				    $calibre='4J';
									
                    if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='4JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='4JDD'){
                          $color='Dark';
                    }else{
                      $color='Light';
                    }
        		}
				if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='3J' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='3JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='3JDD'){
                        $calibre='3J';
                    if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='3JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='3JDD'){
                          $color='Dark';
                    }else{
                      $color='Light';
                    }
				}
				if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='2J' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='2JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='2JDD'){
                    $calibre='2J';
                    if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='2JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='2JDD'){
                            $color='Dark';
				...
				if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='J' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='JDD'){
                        $calibre='J';
                    if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='JD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='JDD'){
                            $color='Dark';
                    }else{
                        $color='Light';
                    }
                }
			    if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='XL' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='XLD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='XLDD'){
                    $calibre='XL';
                  if (preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='XLD' || preg_replace('/[\.\-\s]+/', '', strtolower($masa->n_calibre))=='XLDD'){
                          $color='Dark';
                    }else{
                      $color='Light';
                    }
